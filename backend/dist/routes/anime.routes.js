...
// Admin routes
router.post('/', auth_middleware_1.authMiddleware, role_middleware_1.adminOnly, validate_middleware_1.animeValidation, anime_controller_1.AnimeController.create);
router.put('/:id', auth_middleware_1.authMiddleware, role_middleware_1.adminOnly, anime_controller_1.AnimeController.update);
