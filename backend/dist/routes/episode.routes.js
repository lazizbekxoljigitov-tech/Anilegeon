...
// Admin routes
router.post('/', auth_middleware_1.authMiddleware, role_middleware_1.adminOnly, episode_controller_1.EpisodeController.create);
router.put('/:id', auth_middleware_1.authMiddleware, role_middleware_1.adminOnly, episode_controller_1.EpisodeController.update);
